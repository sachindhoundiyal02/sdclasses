...
const features = [
  { icon: "📐", title: "Formulas Library", desc: "Math, Physics, Chemistry ke saare important formulas ek jagah." },
  { icon: "📄", title: "Question Papers", desc: "Previous year papers download karo free mein." },
  { icon: "⚡", title: "Fast & Easy", desc: "Quickly search karo aur apna topic dhundo." },
  { icon: "📱", title: "Mobile Friendly", desc: "Phone pe bhi perfectly kaam karta hai." },
];
...
const batches = [
  { name: "Class 10 Batch", date: "1 April 2026", seats: "20 Seats Left", msg: "Mujhe Class 10 batch ke baare mein jaankari chahiye" },
  { name: "Class 11 Science", date: "5 April 2026", seats: "15 Seats Left", msg: "Mujhe Class 11 Science batch ke baare mein jaankari chahiye" },
  { name: "Class 12 Boards", date: "10 April 2026", seats: "10 Seats Left", msg: "Mujhe Class 12 Boards batch ke baare mein jaankari chahiye" },
];

const WHATSAPP_NUMBER = "8595443449";  
    ...
    <div className="font-sans text-gray-800">
      ...
      <section className="bg-linear-to-bl from-red-900 via-red-800 to-red-800  text-white py-24 px-6 text-center">
        ...
        <p className="text-xl text-white max-w-2xl mx-auto mb-8">
          Saare Formulas, Question Papers aur Study Material ek hi jagah. 
          Free mein access karo aur apni preparation strong banao!
        </p>
        ...
        <div className="max-w-5xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
          {stats.map((s, i) => (
            <div key={i} className="bg-white rounded-2xl py-8 shadow">
              <div className="text-4xl font-extrabold text-red-700">{s.number}</div>
      ...
      <section className="py-16 px-6 bg-white">
        <div className="max-w-5xl mx-auto">
          ...
          <p className="text-center text-gray-400 mb-10">
            Jo cheez EduSite ko special banati hai
          </p>
      ...
      <section className="py-16 px-6 bg-red-50">
        <div className="max-w-5xl mx-auto">
          ...
          <p className="text-center text-gray-400 mb-10">
            In subjects ke formulas available hain
          </p>
      ...
      <section className="py-16 px-6 bg-white">
        <div className="max-w-5xl mx-auto">
          ...
          <p className="text-center text-gray-400 mb-10">
            Naye session ke batches shuru hone wale hain — abhi join karo!
          </p>
